...
const SENTIMENT_FLAG_LABELS: Record<string, { label: string; type: 'fav' | 'hos' }> = {
  ...
  btc_bearish:     { label: 'BTC below 4H 50EMA — bearish structure (primary)',         type: 'fav' },
  btc_bullish:     { label: 'BTC above 4H 50EMA — bullish structure (primary)',         type: 'hos' },
  fng_fear:        { label: 'F&G fear (≤35) — confirms bearish trend',                  type: 'fav' },
  fng_greed:       { label: 'F&G greed (≥60) — confirms bullish trend',                 type: 'hos' },
  btc_below_d200:  { label: 'BTC below daily 200EMA — bearish higher timeframe',        type: 'fav' },
  btc_above_d200:  { label: 'BTC above daily 200EMA — bullish higher timeframe',        type: 'hos' },
