            ...
            <div className="mt-12 max-w-3xl mx-auto rounded-xl border border-border bg-zinc-900 p-6">
              ...
              <ol className="mt-5 space-y-4 text-sm">
                ...
                <li className="flex gap-3">
                  ...
                  <p className="text-muted-foreground">Access unlocks on your account the moment the payment confirms, for your full term — short and long signals both. Telegram is optional.</p>
                </li>
              </ol>
