/**
 * The Discord brand mark.
 *
 * Extracted from the Discord CTA so the path data exists in exactly one place —
 * it is now used by both the header button and the CTA banner, and pasting a
 * 700-character path into two files is how they silently drift apart.
 */
